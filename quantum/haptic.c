...
#ifdef HAPTIC_SOLENOID
    solenoid_setup();
    dprintfmt("Solenoid driver initialized\n");
#endif
#ifdef HAPTIC_DRV2605L
    drv2605l_init();
    dprintfmt("DRV2605 driver initialized\n");
#endif
...
void eeconfig_debug_haptic(void) {
    dprintfmt("haptic_config eeprom\n");
    dprintfmt("haptic_config.enable = %d\n", haptic_config.enable);
    dprintfmt("haptic_config.mode = %d\n", haptic_config.mode);
}

void haptic_enable(void) {
    set_haptic_config_enable(true);
    dprintfmt("haptic_config.enable = %u\n", haptic_config.enable);
...
void haptic_feedback_toggle(void) {
    ...
    dprintfmt("haptic_config.feedback = %u\n", !haptic_config.feedback);
    eeconfig_update_haptic(haptic_config.raw);
}
...
void haptic_reset(void) {
    ...
    eeconfig_update_haptic(haptic_config.raw);
    dprintfmt("haptic_config.feedback = %u\n", haptic_config.feedback);
    dprintfmt("haptic_config.mode = %u\n", haptic_config.mode);
}
...
void haptic_set_amplitude(uint8_t amp) {
    ...
    eeconfig_update_haptic(haptic_config.raw);
    dprintfmt("haptic_config.amplitude = %u\n", haptic_config.amplitude);
#ifdef HAPTIC_DRV2605L
...
void haptic_set_buzz(uint8_t buzz) {
    ...
    eeconfig_update_haptic(haptic_config.raw);
    dprintfmt("haptic_config.buzz = %u\n", haptic_config.buzz);
}

void haptic_set_dwell(uint8_t dwell) {
    haptic_config.dwell = dwell;
    eeconfig_update_haptic(haptic_config.raw);
    dprintfmt("haptic_config.dwell = %u\n", haptic_config.dwell);
}
...
void haptic_enable_continuous(void) {
    ...
    dprintfmt("haptic_config.cont = %u\n", haptic_config.cont);
    eeconfig_update_haptic(haptic_config.raw);
#ifdef HAPTIC_DRV2605L
    drv2605l_rtp_init();
#endif
